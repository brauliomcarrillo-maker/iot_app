...
class HBuildingDevices extends StatefulWidget {
  const HBuildingDevices({super.key});

  @override
  State<HBuildingDevices> createState() => _HBuildingDevicesState();
}

class _HBuildingDevicesState extends State<HBuildingDevices> {
  ...
  void initState() {
    super.initState();
    _devicesFuture = _haService.getRelevantDevices(buildingFilter: 'H');
  }
